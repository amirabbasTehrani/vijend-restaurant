"""
Django settings for vijend_backend project.
...
ROOT_URLCONF = "vijend_backend.urls"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                'menu.context_processors.parent_categories',
            ],
        },
    },
]
...
WSGI_APPLICATION = "vijend_backend.wsgi.application"
